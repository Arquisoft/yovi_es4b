...
|`auth_service` centralizes login and token validation, passwords are hashed with `scrypt`, sessions use JWT, and the internal stats endpoint requires a service token.
|===
