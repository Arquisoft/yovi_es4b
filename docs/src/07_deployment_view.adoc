...
The Webapp container serves the production React build as static files through Nginx.
Node.js is only used during the image build stage to compile the frontend assets.
