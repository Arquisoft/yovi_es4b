...
mod tests {
    ...
    #[test]
    fn test_greedy_bot_evaluate_win_and_loss() {
        ...
        let lose_score = GreedyBot::evaluate_board(&game, crate::PlayerId::new(1));
    ...
    #[test]
    fn test_greedy_bot_prefers_immediate_win() {
        let bot = GreedyBot;
        let mut game = GameY::new(3);
        ...
        // next player is 0 and the winning cell is (0,2,0)
